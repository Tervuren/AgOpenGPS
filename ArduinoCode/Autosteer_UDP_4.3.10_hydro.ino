////////////// User Settings /////////////////////////////
   ...
   * So your new WAS_ZERO is 2706.
     modif le 22/03/21 ================================ by jossic jean-marc
     to deactivate autosteer with a hydraulic valve:
     encoder: connect to remote
     4-20 ma pressure transducer: connect to aux 2 with a 250 ohm resistor between aux2 and gnd
     pressure transducer:  0-5 v conneter a aux2
     ---------------------------------------------------------   
   */ 
...
// modif le 22/03/21 ================================
// Lecture transducteur de pression pour désengager
// BY slimfarmer
